...
class ProductController extends Controller
{
    ...
    public function editProduct(Request $request, $id){
        ...
        if($request->isMethod('post')){
            ...
            Product::where(['id' => $id])->update(['category_id' => $data['category_id'], 'product_name' => ucwords(strtolower($data['product_name'])), 'product_code' => $data['product_code'], 'product_color' => $data['product_color'], 'price' => $data['price'], 'description' => $data['description'], 'image' => $filename, 'care' => $data['care'], 'status' => $status
            ]);
...
//                Size Check
    ...
    public function addImages(Request $request, $id){
        ...
        return view ('admin.products.add_image', compact('productDetails', 'productImages'));
    }
    ...
    public function editAttributes(Request $request, $id){
        if($request->isMethod('post')){
            $data = $request->all();
//            echo "<pre>"; print_r($data); die; display
