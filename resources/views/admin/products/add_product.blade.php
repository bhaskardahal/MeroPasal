                    ...
                    <div class="card-body">
                        ...
                        <form class="form" method="post" action="{{route('product.add')}}" id="add_product" name="add_product" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="product_name" id="product_name" placeholder="Please Enter Product Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="product_code" id="product_code" placeholder="Please Enter Product Code">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="product_color" id="product_color" placeholder="Please Enter Product Color">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="price" id="price" placeholder="Please Enter Product Price">
                                </div>
                            </div>
